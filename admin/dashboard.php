...
// User is authenticated, proceed with the dashboard logic
...
?>
    ...
    <button type="submit" style="background-color: tomato; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer;">
        Log Out
    </button>
</form>
                        </a>
            ...
            <div class="row mt-4">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="d-flex flex-column h-100">
                                        <p class="mb-1 pt-2 text-bold">Built by Apricron Solutions</p>
                                        <h5 class="font-weight-bolder">Apricron Solutions Dashboard</h5>
                                ...
                                <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                                    <div class="bg-primary border-radius-lg h-100">
                                        ...
                                        <div class="position-relative d-flex align-items-center justify-content-center h-100">
                                            <img class="w-100 position-relative z-index-2 pt-4" src="./assets2/img/illustrations/rocket-white.png" alt="rocket">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-5">
                    <div class="card h-100 p-3">
                        <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('./assets2/img/ivancik.jpg');">
                    ...
                    <div class="card z-index-2">
                        <div class="card-body p-2">
                            <div class="bg-dark border-radius-md py-3 pe-1 mb-3">
                                <div class="chart">
                                <canvas id="chart-bars" class="chart-canvas" height="340" width="1112" style="display: block; box-sizing: border-box; height: 170px; width: 556px;"></canvas>   
